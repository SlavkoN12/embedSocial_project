            ...
            <div class="top">
                <div class="userDetails">
                    <div class="profile_img">
                        <img class="cover_top" src="${dataJson[i].profile_image}" alt="">
                    </div>
                    <h3>${dataJson[i].name}<br><span">${dataJson[i].date}</span></h3>
                </div>
                <div>
                <a href="https://instagram.com/embedsocial/"><img class="insta_logo" src="img/instagram-logo.svg" alt=""></a>
                </div>
            </div>
            <div class="imgBx">
                <img class="cover_post" src="${dataJson[i].image}" alt="">
            </div>
            <div class="actionBtn">
                <div class="heartBtn">
                ...
                <div class="fbBtn">
                <a href="https://www.facebook.com/EmbedSocial/"><img class="fb" src="img/facebook.svg" alt=""></a>
                </div>
            </div>
            <h4 class="likes">${dataJson[i].likes}</h4>
            <h4 class="comment">${dataJson[i].caption}<b></b></h4>
        `;
